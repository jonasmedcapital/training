function changeNumberToCrm(element) {

  // element.val(crmMask(element.val()));
  // element.blur(function () {
  //   if ($(this).val().length <= 11) {
  //     $(this).val(crmMask($(this).val()));
  //   } else {
  //     $(this).val(cnpjMask($(this).val()));
  //   }
  // });

  function crmMask(value) {
    value = fromCrmToNumber(value);
